...
public class Server implements ActionListener
{
    ...
    public Server()
    {
        ...
        JLabel name = new JLabel("Prem Shinde");
    ...
    public static JPanel formatLabel(String out)
    {
        ...
        JLabel output = new JLabel("<html><p style=\"width: 160px ; padding: 10px\">"+ out +"</p></html>");
        output.setFont(new Font("Tahoma", Font.PLAIN , 16));
        output.setBackground(new Color(0, 201, 168));
